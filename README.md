# Yuan project template

This is a project template for a greenfield Java project. It's named after the Java mascot _Yuan_. Given below are
...
1. After that, locate the `src/main/java/Yuan.java` file, right-click it, and choose `Run Yuan.main()` (if the code
